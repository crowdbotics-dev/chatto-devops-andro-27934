...
## Project Structure
    ...
    ├── chatto_devops_andro_27934  # Django project configurations
...
1. Clone this repo and `cd chatto_devops_andro_27934`
...
2. Clone this repo and `cd chatto_devops_andro_27934`
